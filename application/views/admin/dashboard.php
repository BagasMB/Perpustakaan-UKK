              ...
              <div class="col-7">
                <div class="d-flex align-items-center">
                  <svg
                    ...
                    style="width: 10px">
                    <use
                      xlink:href="<?= base_url('assets/backend/'); ?>static/images/bootstrap-icons.svg#circle-fill" />
                  </svg>
                ...
                <tbody>
                    ...
                    <td class="col-3">
                      <div class="d-flex align-items-center">
                        <div class="avatar avatar-md">
                          <img src="<?= base_url('assets/backend/'); ?>compiled/jpg/5.jpg" />
                        </div>
                  ...
                  <tr>
                    <td class="col-3">
                      <div class="d-flex align-items-center">
                        <div class="avatar avatar-md">
                          <img src="<?= base_url('assets/backend/'); ?>compiled/jpg/2.jpg" />
                        </div>
      ...
      <div class="card-body py-4 px-4">
        <div class="d-flex align-items-center">
          <div class="avatar avatar-xl">
            <img src="<?= base_url('assets/backend/'); ?>compiled/jpg/1.jpg" alt="Face 1" />
          </div>
          <div class="ms-3 name">
      ...
      <div class="card-content pb-4">
        <div class="recent-message d-flex px-4 py-3">
          <div class="avatar avatar-lg">
            <img src="<?= base_url('assets/backend/'); ?>compiled/jpg/4.jpg" />
          </div>
          <div class="name ms-4">
